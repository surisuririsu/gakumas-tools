...
export async function resolve(specifier, context, nextResolve) {
    ...
    if (specifier === 'gakumas-engine') {
        const url = pathToFileURL(path.join(rootDir, 'packages/gakumas-engine/index.js')).href;
        return nextResolve(url, context);
    }
    if (specifier === 'gakumas-data') {
        const url = pathToFileURL(path.join(rootDir, 'packages/gakumas-data/index.js')).href;
        return nextResolve(url, context);
    }
